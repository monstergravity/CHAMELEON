...
const PAINTINGS_GALLERY: PaintingData[] = [
  ...
  {
    id: 'chromamap',
    name: '色域领地 (Chromatic Territories)',
    nameEn: 'Chromatic Territories',
    artist: '程序化色域竞技场',
    artistEn: 'Procedural Territory Arena',
    year: '2026',
    description: '一张更大的抽象领地地图，底色由不规则色块组成。玩家从小片初始领地出发，画出闭合路线后一次性扩张区域；单人占领 70% 后开门，双人 3 分钟内占领更多者获胜。',
    descriptionEn: 'A larger abstract territory map built from irregular color fields. Start with a small home zone, draw closed paths to claim whole regions, open the gate at 70% in solo, or win the 3-minute duel by owning more territory.',
    url: 'procedural://chromamap',
    difficulty: '噩梦',
    backgroundColor: 'bg-fuchsia-950/45',
    guardCount: 7,
    guardSpeed: 1.98,
    visionRange: 225,
    restorationTargetPercent: 70,
    guardMix: ['inspector', 'sweeper', 'curator', 'drone', 'sentinel', 'sweeper', 'curator'],
    duelEnabled: true,
    territoryMap: true,
    duelDurationSeconds: 180,
    proceduralType: 'chromamap',
    palette: [
      { name: '电光紫 (Electric Violet)', nameEn: 'Electric Violet', hex: '#7c3aed' },
      { name: '热区黄 (Hot Zone Yellow)', nameEn: 'Hot Zone Yellow', hex: '#facc15' },
      { name: '酸性绿 (Acid Green)', nameEn: 'Acid Green', hex: '#84cc16' },
      { name: '深海青 (Deep Cyan)', nameEn: 'Deep Cyan', hex: '#0891b2' },
      { name: '玫红裂隙 (Magenta Rift)', nameEn: 'Magenta Rift', hex: '#db2777' },
    ],
  }
];
